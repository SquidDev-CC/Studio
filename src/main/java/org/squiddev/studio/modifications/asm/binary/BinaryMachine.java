	...
	private ClassVisitor patchWrappedObject(ClassVisitor visitor) {
		...
		visitor = new FindingVisitor(
			...
			public void handle(InsnList nodes, MethodVisitor visitor) {
				...
				visitor.visitMethodInsn(INVOKESTATIC, "org/squiddev/studio/modifications/lua/LuaHelpers", "delegateLuaObject", "(Ldan200/computercraft/api/lua/ILuaObject;Ldan200/computercraft/api/lua/ILuaContext;ILorg/luaj/vm2/Varargs;)[Ljava/lang/Object;", false);
			}
		}.onMethod("invoke").once().mustFind();
