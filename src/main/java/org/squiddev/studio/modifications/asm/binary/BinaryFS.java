...
public class BinaryFS implements IPatcher {
	public static final String READER_OBJECT = "org.squiddev.studio.modifications.patch.binfs.ReaderObject";
	public static final String WRITER_OBJECT = "org.squiddev.studio.modifications.patch.binfs.WriterObject";
	...
	public ClassVisitor patch(final String className, final ClassVisitor delegate) throws Exception {
		if (className.equals("dan200.computercraft.core.filesystem.IMountedFileNormal")) {
			 ...
			 * {@link org.squiddev.studio.modifications.patch.binfs.INormalFile}.
			 *
